           ...
           //这里 250 指的是图片的宽度，可以根据自己的需要调整相册中照片的大小
            li += '<div class="card" style="width:250px">' +
                    ...
                    //href 和 src 的链接地址是相册照片外部链接，也可以放博客目录里
                      '<a data-fancybox="gallery" href="http://q9mx96tuj.bkt.clouddn.com/' + imgNameWithPattern + '?raw=true" data-caption="' + imgName + '">' +
                        '<img src="http://q9mx96tuj.bkt.clouddn.com/' + imgNameWithPattern + '?raw=true"/>' +
                      '</a>' +
                    '</div>' +
